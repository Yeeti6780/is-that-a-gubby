module.exports = {
  ...
  desc: "Creates a global array from a default set of words from the specified keyword name.",
  func: function (matches, msg, _, string) {
    ...
    if (!array) return ''
    tempdata[msg.guild.id][msg.channel.id].arrays[name] = typeof array == 'function' ? array.call(poopy, msg) : array
