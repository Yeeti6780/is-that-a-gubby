...
module.exports = {
  helpf: '(name | seed)',
  desc: 'Globally creates a random generator function given the name and seed. Functions can be used by typing in [functionname].',
  func: function (matches, msg, _, string) {
    ...
    tempdata[msg.guild.id][msg.channel.id].declared[`[${name}]`] = seed
