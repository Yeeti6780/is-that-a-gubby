module.exports = {
    ...
    desc: 'Creates a collector that receives any messages sent in the channel, within the timeout.\n' +
    ...
    func: async function (matches, msg, isBot, _, opts) {
        let poopy = this
        let { splitKeyFunc, parseKeywords, fetchPingPerms, deleteMsgData, createCollector, cleanKeywords } = poopy.functions
