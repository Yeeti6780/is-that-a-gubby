module.exports = {
    ...
    func: async function (matches) {
        ...
        tempdata.channelvideos ??= {}

        var countres = tempdata.channelvideos[id]?.[0] ?? await youtube.search.list({
            channelId: id,
            type: 'video',
            part: 'snippet',
            order: 'date',
        ...
        while (page >= 50) {
            ...
            var nres = tempdata.channelvideos[id][pagecount] ?? await youtube.search.list({
                channelId: id,
                type: 'video',
                part: 'snippet',
                order: 'date',
