module.exports = {
    ...
    execute: async function (msg, args, opts) {
        ...
        if (args[1].match(/^@(here|everyone)$/) && (Math.random() < 0.2 || msg.member.permissions.has(DiscordTypes.PermissionFlagsBits.Administrator) || msg.channel.permissionsFor(msg.member).has(DiscordTypes.PermissionFlagsBits.ManageMessages) || msg.channel.permissionsFor(msg.member).has(DiscordTypes.PermissionFlagsBits.MentionEveryone) || msg.author.id == msg.guild.ownerId || ownerid || opts.ownermode)) {
